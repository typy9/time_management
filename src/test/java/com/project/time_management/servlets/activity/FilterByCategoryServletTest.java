...
class FilterByCategoryServletTest {

    private static final Logger LOG = Logger.getLogger(FilterByCategoryServletTest.class);
    ...
    @InjectMocks
    FilterByCategoryServlet mockServlet;
    ...
    public void setUp() throws IOException {
        ...
        mockServlet = new FilterByCategoryServlet();
