...
class SortActivityByUsersServletTest {

    private static final Logger LOG = Logger.getLogger(SortActivityByUsersServletTest.class);
    ...
    @InjectMocks
    SortActivityByUsersServlet mockServlet;
    ...
    public void setUp() throws IOException {
        ...
        mockServlet = new SortActivityByUsersServlet();
    ...
    void doGetTest() throws ServletException, IOException {
        ...
        verify(mockSession).setAttribute("view", "/activity_sort_by_number_of_users");
