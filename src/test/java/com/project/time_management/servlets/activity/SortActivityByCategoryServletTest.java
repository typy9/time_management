...
class SortActivityByCategoryServletTest {

    private static final Logger LOG = Logger.getLogger(SortActivityByCategoryServletTest.class);
    ...
    @InjectMocks
    SortActivityByCategoryServlet mockServlet;
    ...
    public void setUp() throws IOException {
        ...
        mockServlet = new SortActivityByCategoryServlet();
    ...
    void doGet() throws ServletException, IOException {
        ...
        verify(mockSession).setAttribute("view", "/activity_sort_by_category");
