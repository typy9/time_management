...
class SortActivityByNameServletTest {

    private static final Logger LOG = Logger.getLogger(SortActivityByNameServletTest.class);
    ...
    @InjectMocks
    SortActivityByNameServlet mockServlet;
    ...
    public void setUp() throws IOException {
        ...
        mockServlet = new SortActivityByNameServlet();
    ...
    void doGetTest() throws ServletException, IOException {
        ...
        verify(mockSession).setAttribute("view", "/activity_sort_by_name");
