...
class SortActivityByNameServiceTest {

    private static final Logger LOG = Logger.getLogger(SortActivityByNameServiceTest.class);
    MysqlConnectionPoolDataSource dataSource;
    SortActivityByNameService service;
    ...
    void setUp() {
        ...
        service = new SortActivityByNameService(dataSource);
    }
